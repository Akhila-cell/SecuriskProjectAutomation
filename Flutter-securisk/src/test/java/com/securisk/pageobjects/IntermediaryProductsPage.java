...
public class IntermediaryProductsPage {
	...
	@FindBy(css = "flt-semantics[aria-label='Updated Successfully']")
	public WebElement ConfirmUpdateProduct;
...
//		SearchField.clear();
	...
	public boolean ProductEdited() {
		return (ConfirmUpdateProduct.isDisplayed());
